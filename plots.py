...
def showplots(df1,obv,refresh,Fs,m,pks_v,pks_c,figcols,caller='dump',asset='ETH-USD'):
    ...
    with plt.style.context(style='seaborn'):
        ...
        ax1.plot_date(dates_idx,df1.a2k2,xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a2k2')
        ...
        ax2.plot_date(dates_idx,df_v2,xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a1k1')
        ...
        ax3.plot_date(dates_idx,df_v3,xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='ma1')
        ...
        ax4.plot_date(dates_idx,df1.a1k1,xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a1k1')
        ...
        ax5.plot_date(dates_idx,df_c2,xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a2k2')
        ...
        ax6.plot_date(dates_idx,df_c3,label='ma2',xdate=False,linestyle='dotted',linewidth=0.5,fmt='')
