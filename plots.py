...
def showplots(df1,obv,Fs,refresh=0.5,caller='dump',asset='ETH-USD',alpha=1):
    ...
    with plt.style.context(style='dark_background'):
        ...
        ax1.plot_date(dates_idx,df1.x1_pr,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='x1_pr')
        ax1.plot_date(dates_idx,df1.x1_gn,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='x1_gn')
        ...
        ax2.plot_date(dates_idx,df1.dr1,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='dr1')
        ax2.plot_date(dates_idx,df1.dr2,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='dr2')
        ...
        ax3.plot_date(dates_idx,df1.ma1,label='ma1',xdate=False,linestyle='dotted',linewidth=0.8,fmt='')
        ...
        ax4.plot_date(dates_idx,df1.x2_pr,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='x2_pr')
        ax4.plot_date(dates_idx,df1.x2_gn,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='x2_gn')
        ...
        ax5.plot_date(dates_idx,df1.dr1,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='dr1')
        ax5.plot_date(dates_idx,df1.dr2,xdate=False,linestyle='dotted',fmt='',linewidth=0.8,label='dr2')
        ...
        ax6.plot_date(dates_idx,df1.ma2,label='ma2',xdate=False,linestyle='dotted',linewidth=0.8,fmt='')
        ...
        ax11.step(dates_idx,df1.idposc,label='pos',color='y',linewidth=0.8,linestyle='dotted')
        ...
        ax12.plot(np.rad2deg(df1.Pxa)[-1],df1.Pxm[-1],label='Px',marker='o',markersize=6,linestyle='none')
        ax12.plot(np.rad2deg(df1.Maa),df1.Drm,label='MAx',marker='o',markersize=6,linestyle='none')
        ax12.plot(np.rad2deg(df1.Dra),df1.Drm,label='Drx',marker='o',markersize=6,linestyle='none') 
        ax12.plot(np.rad2deg(df1.Fma),df1.Fmm,label='Fx',marker='o',markersize=6,linestyle='none')
        ax12.plot(np.rad2deg(df1.Qfa),df1.Qfm,label='Qx',marker='o',markersize=6,linestyle='none')

        ax12.annotate('Fx',xy=(df1.Fma[-1],df1.Fmm[-1]),xytext=(df1.Fma[-1],df1.Fmm[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ax12.annotate('Qx',xy=(np.rad2deg(df1.Qfa)[-1],df1.Qfm[-1]),xytext=(np.rad2deg(df1.Qfa)[-1],df1.Qfm[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ax12.annotate('Px',xy=(np.rad2deg(df1.Pxa)[-1],df1.Pxm[-1]),xytext=(np.rad2deg(df1.Pxa)[-1],df1.Pxm[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ax12.annotate('MAx',xy=(np.rad2deg(df1.Maa)[-1],df1.Mam[-1]),xytext=(np.rad2deg(df1.Maa)[-1],df1.Mam[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ax12.annotate('Drx',xy=(np.rad2deg(df1.Dra)[-1],df1.Drm[-1]),xytext=(np.rad2deg(df1.Dra)[-1],df1.Drm[-1]),xycoords='data',textcoords='data',fontweight='bold')
