...
def showplots(df1,obv,F,refresh=0.5,caller='dump',asset='ETH-USD'):
    ...
    with plt.style.context(style='fast'):
        ...
        df_v3 = df1[['ft1','ma1','ff1','psr1']]
        df_v2 = df1[['dr1','lmda1','q1','rf1']]
        ...
        # ax1.step(dates_idx[-wndtr:],df1.pos[-wndtr:],label='pos1',linewidth=0.8,linestyle='dotted',marker='')
        ...
        df_c3 = df1[['ft2','ma2','ff2','psr2']]
        df_c2 = df1[['dr2','lmda2','q2','rf2']]
        ...
        # ax4.step(dates_idx[-wndtr:],df1.pos[-wndtr:],label='pos1',linewidth=0.8,linestyle='dotted',marker='')
        ...
        ax7.plot(df1.x1.mean(),df1.x2.mean(),color='r',linestyle='None',marker='o')
        ax7.plot(df1.x1.iloc[-1],df1.x2.iloc[-1],color='g',linestyle='None',marker='o')
        ax7.plot(df1.xg2.iloc[-1],df1.xg2.iloc[-1],color='g',linestyle='None',marker='o')
        ax7.plot(df1.xp1.iloc[-1],df1.xp2.iloc[-1],color='g',linestyle='None',marker='o')
        # ax7.plot(df1.ft1.iloc[-1],df1.ft2.iloc[-1],linestyle='None',marker='o')
        # ax7.plot(df1.ma1.iloc[-1],df1.ma2.iloc[-1],linestyle='None',marker='o')
        # ax7.plot(df1.ff1.iloc[-1],df1.ff2.iloc[-1],linestyle='None',marker='o')
        # ax7.plot(df1.dr1.iloc[-1],df1.dr2.iloc[-1],linestyle='None',marker='o')
        # ax7.plot(df1.q1.iloc[-1],df1.q2.iloc[-1],linestyle='None',marker='o')
        # ax7.plot(df1.wrk1.iloc[-1],df1.wrk2.iloc[-1],linestyle='None',marker='o')
        # ax7.plot(df1.rf1.iloc[-1],df1.rf2.iloc[-1],linestyle='None',marker='o')

        ax7.annotate('Cm',xy=(df1.x1.mean(),df1.x2.mean()),xytext=(df1.x1.mean(),df1.x2.mean()),fontweight='bold',xycoords='data',textcoords='data')
        ax7.annotate('Px',xy=(df1.x1.iloc[-1],df1.x2.iloc[-1]),xytext=(df1.x1.iloc[-1],df1.x2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ...
        # ax7.annotate('Fx',xy=(df1.ft1.iloc[-1],df1.ft2.iloc[-1]),xytext=(df1.ft1.iloc[-1],df1.ft2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax7.annotate('Max',xy=(df1.ma1.iloc[-1],df1.ma2.iloc[-1]),xytext=(df1.ma1.iloc[-1],df1.ma2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax7.annotate('Ffx',xy=(df1.ff1.iloc[-1],df1.ff2.iloc[-1]),xytext=(df1.ff1.iloc[-1],df1.ff2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax7.annotate('Drx',xy=(df1.dr1.iloc[-1],df1.dr2.iloc[-1]),xytext=(df1.dr1.iloc[-1],df1.dr2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax7.annotate('Qx',xy=(df1.q1.iloc[-1],df1.q2.iloc[-1]),xytext=(df1.q1.iloc[-1],df1.q2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax7.annotate('Wkx',xy=(df1.wrk1.iloc[-1],df1.wrk2.iloc[-1]),xytext=(df1.wrk1.iloc[-1],df1.wrk2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax7.annotate('Rfx',xy=(df1.rf1.iloc[-1],df1.rf2.iloc[-1]),xytext=(df1.rf1.iloc[-1],df1.rf2.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')

        #SECTION 4: MAG AND ENERGY PLOTS
        ax10 = plt.subplot2grid((gx,gy),(3*(s1x+s1rs+1),s1y),rowspan=s4rs,colspan=s1cs)
        ax10.magnitude_spectrum(df1.x1,Fs=Fs,scale='dB',linestyle='none',markersize='5',marker='o',label='vt')
        ax10.magnitude_spectrum(df1.x2,Fs=Fs,scale='dB',linestyle='none',markersize='5',marker='o',label='ct')
        ax10.legend(loc='upper left')
    
        ax11 = plt.subplot2grid((gx,gy),(3*(s1x+s1rs+1),s1y+s1cs+1),rowspan=s4rs,colspan=s1cs)
        ax11.step(dates_idx[-wndtr:],df1.te1[-wndtr:],label='te1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.te2[-wndtr:],label='te2',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.ke1[-wndtr:],label='ke1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.ke2[-wndtr:],label='ke2',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pe1[-wndtr:],label='pe1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pe2[-wndtr:],label='pe2',linewidth=1,linestyle='dotted')
        ...
        # ax11.step(dates_idx[-wndtr:],df1.pos[-wndtr:],label='pos1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pwr1[-wndtr:],label='pwr1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pwr2[-wndtr:],label='pwr2',linewidth=1,linestyle='dotted')
        # ax11.step(dates_idx[-wndtr:],df1.xp2t[-wndtr:],label='xp2t',linewidth=1,linestyle='dotted')
        # ax11.step(dates_idx[-wndtr:],df1.xg1rt[-wndtr:],label='xg1rt',linewidth=1,linestyle='dotted')
        # ax11.step(dates_idx[-wndtr:],df1.xg2rt[-wndtr:],label='xg2rt',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.rf1[-wndtr:],label='rf1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.rf2[-wndtr:],label='rf2',linewidth=1,linestyle='dotted')
        # ax11.step(dates_idx[-wndtr:],df1.Trq[-wndtr:],label='Torq',linewidth=1,linestyle='dotted')
        # ax11.step(dates_idx[-wndtr:],df1.Rst[-wndtr:],label='Imped',linewidth=1,linestyle='dotted')
        ...
        # ax12.plot(df1.Xga.iloc[-1],df1.Xgm.iloc[-1],label='Xg',marker='o',markersize=6,linestyle='none')
        ...
        ax12.plot(df1.Pxa.iloc[-1],df1.Pxm.iloc[-1],label='Px',marker='o',markersize=6,linestyle='none')
        ...
        # ax12.annotate('Qx',xy=(df1.Qfa.iloc[-1],df1.Qfm.iloc[-1]),xytext=(df1.Qfa.iloc[-1],df1.Qfm.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ...
        ax12.annotate('Px',xy=(df1.Pxa.iloc[-1],df1.Pxm.iloc[-1]),xytext=(df1.Pxa.iloc[-1],df1.Pxm.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax12.annotate('Xg',xy=(df1.Xga.iloc[-1],df1.Xgm.iloc[-1]),xytext=(df1.Xga.iloc[-1],df1.Xgm.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax12.annotate('Xp',xy=(df1.Xpa.iloc[-1],df1.Xpm.iloc[-1]),xytext=(df1.Xpa.iloc[-1],df1.Xpm.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
        # ax12.annotate('Drx',xy=(df1.Dra.iloc[-1],df1.Drm.iloc[-1]),xytext=(df1.Dra.iloc[-1],df1.Drm.iloc[-1]),xycoords='data',textcoords='data',fontweight='bold')
...
def showplots2(df1,obv,F,refresh=0.5,caller='dump',asset='ETH-USD'):
    pd.plotting.register_matplotlib_converters()
    ...
    with plt.style.context(style='fast'):
        ...
        ttl = f'Analysis Dashboard - Asset:{asset} |N={len(df1)} |wnd={wndtr} |T={round(T,3)} |Fs={round(Fs,3)} |F={round(df,3)} |W={round(dw,3)} |Fn={round(ny,3)}'
        ...
        ax11 = plt.subplot2grid((gx,gy),(3*(s1x+s1rs+1),s1y+s1cs+1),rowspan=s4rs,colspan=s1cs)
        ax11.step(dates_idx[-wndtr:],df1.te1[-wndtr:],label='te1',linewidth=0.7,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.te2[-wndtr:],label='te2',linewidth=0.7,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.ke1[-wndtr:],label='ke1',linewidth=0.7,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.ke2[-wndtr:],label='ke2',linewidth=0.7,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pe1[-wndtr:],label='pe1',linewidth=0.7,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pe2[-wndtr:],label='pe2',linewidth=0.7,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pwr1[-wndtr:],label='pwr1',linewidth=0.7,linestyle='dotted')
        ax11.step(dates_idx[-wndtr:],df1.pwr2[-wndtr:],label='pwr2',linewidth=0.7,linestyle='dotted')
        ax11.legend(loc='lower left')
