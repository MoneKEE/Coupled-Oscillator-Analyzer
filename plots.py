...
def showplots(df1,obv,Fs,refresh=0.5,caller='dump',asset='ETH-USD',alpha=1):
    ...
    with plt.style.context(style='seaborn'):
        ...
        ax1.plot_date(dates_idx,df1.x1_pr,xdate=False,color='m',linestyle='dotted',fmt='',linewidth=0.5,label='x1_pr')
        ax1.plot_date(dates_idx,df1.x1_gn,xdate=False,color='c',linestyle='dotted',fmt='',linewidth=0.5,label='x1_gn')
        ...
        ax2.plot_date(dates_idx,df1.a1k1,color='m',xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a1k1')
        ax2.plot_date(dates_idx,df1.a2k2,color='c',xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a2k2')
        ...
        ax3.plot_date(dates_idx,df1.ma1,label='ma1',color='m',xdate=False,linestyle='dotted',linewidth=0.5,fmt='')
        ...
        ax4.plot_date(dates_idx,df1.x2_pr,xdate=False,color='m',linestyle='dotted',fmt='',linewidth=0.5,label='x2_pr')
        ax4.plot_date(dates_idx,df1.x2_gn,xdate=False,color='c',linestyle='dotted',fmt='',linewidth=0.5,label='x2_gn')
        ...
        ax5.plot_date(dates_idx,df1.a1k1,color='m',xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a1k1')
        ax5.plot_date(dates_idx,df1.a2k2,color='c',xdate=False,linestyle='dotted',fmt='',linewidth=0.5,label='a2k2')
        ...
        ax6.plot_date(dates_idx,df1.ma2,label='ma2',color='m',xdate=False,linestyle='dotted',linewidth=0.5,fmt='')
        ...
        ax7.annotate('AKx',xy=(df1.a1k1[-1],df1.a2k2[-1]),xytext=(df1.a1k1[-1],df1.a2k2[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ...
        ax12.annotate('AKx',xy=(np.rad2deg(np.arctan(df1.a2k2/df1.a1k1))[-1],np.sqrt(df1.a1k1**2+df1.a2k2**2)[-1]),xytext=(np.rad2deg(np.arctan(df1.a2k2/df1.a1k1))[-1],np.sqrt(df1.a1k1**2+df1.a2k2**2)[-1]),xycoords='data',textcoords='data',fontweight='bold')
