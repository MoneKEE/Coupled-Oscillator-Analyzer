...
def showplots(df1,obv,Fs,refresh=0.5,caller='dump',asset='ETH-USD'):
    ...
    with plt.style.context(style='fast'):
        ...
        ax2.plot_date(dates_idx,df_v2,xdate=False,marker='',linestyle='dotted',linewidth=0.8,label=df_v2.columns)
        ...
        ax5.plot_date(dates_idx,df_c2,xdate=False,marker='',linestyle='dotted',linewidth=0.8,label=df_c2.columns)
        ...
        ax7.plot(df1.x1_gn[-1],df1.x2_gn[-1],color='g',linestyle='None',marker='o')
        ax7.plot(df1.x1_pr[-1],df1.x2_pr[-1],color='g',linestyle='None',marker='o')
        ax7.plot(df1.ft1[-1],df1.ft2[-1],linestyle='None',marker='o')
        ax7.plot(df1.ma1[-1],df1.ma2[-1],linestyle='None',marker='o')
        ax7.plot(df1.ff1[-1],df1.ff2[-1],linestyle='None',marker='o')
        ...
        ax7.annotate('Xg',xy=(df1.x1_gn[-1],df1.x2_gn[-1]),xytext=(df1.x1_gn[-1],df1.x2_gn[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ax7.annotate('Xp',xy=(df1.x1_pr[-1],df1.x2_pr[-1]),xytext=(df1.x1_pr[-1],df1.x2_pr[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ...
        ax7.annotate('Ffx',xy=(df1.ff1[-1],df1.ff2[-1]),xytext=(df1.ff1[-1],df1.ff2[-1]),xycoords='data',textcoords='data',fontweight='bold')
        ...
        # ax11.step(dates_idx,df1.TEr,label='TEr',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx,df1.Kr1,label='Kr1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx,df1.Kr2,label='Kr2',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx,df1.Pr1,label='Pr1',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx,df1.Pr2,label='Pr2',linewidth=1,linestyle='dotted')
        ax11.step(dates_idx,df1.idpos1,label='pos1',linewidth=0.8,linestyle='dotted', alpha=0.8)
        ax11.step(dates_idx,df1.Xpr1,label='Xpr1',linewidth=0.8,linestyle='dotted', alpha=0.8)
        ax11.step(dates_idx,df1.Xpr2,label='Xpr2',linewidth=0.8,linestyle='dotted', alpha=0.8)
        ax11.step(dates_idx,df1.Xgr1,label='Xgr1',linewidth=0.8,linestyle='dotted', alpha=0.8)
        ax11.step(dates_idx,df1.Xgr2,label='Xgr2',linewidth=0.8,linestyle='dotted', alpha=0.8)
        ax11.step(dates_idx,df1.rf1,label='rf1',linewidth=0.8,linestyle='dotted', alpha=0.8)
        ax11.step(dates_idx,df1.rf2,label='rf2',linewidth=0.8,linestyle='dotted', alpha=0.8)
